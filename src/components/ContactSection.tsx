          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="flex-shrink-0 bg-netspire-pink bg-opacity-20 p-3 rounded-lg mr-4">
              ...
              <div className="flex space-x-4">
                {['Twitter', 'LinkedIn', 'Instagram', 'GitHub'].map((platform) => (
                  <motion.a 
                    ...
                    className="bg-netspire-gray bg-opacity-30 p-3 rounded-full text-white hover:bg-netspire-pink hover:bg-opacity-20 transition-colors"
                  >
